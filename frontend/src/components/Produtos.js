...
const Produtos = () => {
  ...
  return (
    <div className="produtos-container text-light">
      ...
      <button className="btn btn-monster mb-3" onClick={() => setMostrarFormulario(!mostrarFormulario)}>
        {mostrarFormulario ? 'Fechar Formulário' : 'Cadastrar Novo Produto'}
      </button>

      {mostrarFormulario && <NovoProduto onProdutoCadastrado={carregarProdutos} />}
...
// Define imagem animada para cada produto, conforme o nome
